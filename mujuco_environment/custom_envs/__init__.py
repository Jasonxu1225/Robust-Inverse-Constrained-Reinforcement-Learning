...
register(
    id="InvertedPendulumAngle-v0",
    entry_point=ABS_PATH+".inverted_pendulum:InvertedPendulumAngle",
    max_episode_steps=PENDULUM_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="HCWithTwoPos-v0",
    entry_point=ABS_PATH+".half_cheetah:HalfCheetahWithTwoPos",
    max_episode_steps=CHEETAH_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="HCWithTwoPosNoise-v0",
    entry_point=ABS_PATH+".half_cheetah:HalfCheetahWithTwoPosNoise",
    max_episode_steps=CHEETAH_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="WalkerWithAngle-v0",
    entry_point=ABS_PATH+".walker:WalkerWithAngle",
    max_episode_steps=WALKER_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="WalkerWithAngleNoise-v0",
    entry_point=ABS_PATH+".walker:WalkerWithAngleNoise",
    max_episode_steps=WALKER_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="WalkerWithAngleWithOp-v0",
    entry_point=ABS_PATH+".walker:WalkerWithAngleWithOp",
    max_episode_steps=WALKER_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="AntWallWithNoise-v0",
    entry_point=ABS_PATH+".ant:AntWallWithNoise",
    max_episode_steps=ANT_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
...
register(
    id="WindyWGW-v0",
    entry_point=ABS_PATH+".wall_gird_word:WindyWallGridworld",
    max_episode_steps=WALL_GRID_WORLD_LEN,
    reward_threshold=None,
    nondeterministic=False,
)
