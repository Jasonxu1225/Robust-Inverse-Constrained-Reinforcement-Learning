...
from stable_baselines3.common.on_policy_algorithm import \
    OnPolicyWithCostAlgorithm, OnPolicyWithCostWithOpAlgorithm_onepolicy
from stable_baselines3.common.policies import ActorCriticPolicy
from stable_baselines3.common.type_aliases import GymEnv, MaybeCallback
from stable_baselines3.common.utils import explained_variance, get_schedule_fn


class RPPOLagrangian(OnPolicyWithCostWithOpAlgorithm_onepolicy):
    ...
    def __init__(
        ...
        super(RPPOLagrangian, self).__init__(
            policy,
            env,
    ...
    def _setup_model(self) -> None:
        super(RPPOLagrangian, self)._setup_model()
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if self.op_type == 'both':
                    ...
                    op_policy_loss -= current_penalty * th.mean(cost_advantages * op_ratio)
    ...
    def learn(
        ...
        tb_log_name: str = "RPPOLagrangian",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> "RPPOLagrangian":

        return super(RPPOLagrangian, self).learn(
